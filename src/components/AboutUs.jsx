    ...
    <div className="about-us">
     ...
     <img src="about-image.png" alt="Our Mission" className="mission-image" />
      ...
      <section className="our-team">
        <h2>Our Team</h2>
        <p className='text'>At Petti Ecom, our diverse team is the backbone of our success. From logistics experts to customer service representatives, each member is passionate about making a difference. Our team's extensive experience and dedication ensure smooth operations and exceptional service for our customers.</p>
      </section>
      <Footer/>
    </div>
  );
